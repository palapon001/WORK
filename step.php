                 ...
                 <div class="container mt-3">
                     <div class="card">
                         <div class="card-body">
                             ...
                             <input name="orgHeal[]" type="hidden" id="orgHeal" value="---">
                             <input name="orgHealInput" type="hidden" id="orgHealInput" value="---">
                             <input name="proOrgExer[]" type="hidden" id="proOrgExer" value="---">
                             <input name="proOrgExerInput" type="hidden" id="proOrgExerInput" value="---">
                             <input name="activityName[]" type="hidden" id="activityName" value="---">
                             <input name="activityNameInput" type="hidden" id="activityNameInput" value="---">
