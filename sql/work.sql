...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2023 at 08:28 AM
...
CREATE TABLE `question` (
  ...
  `eduOptions` varchar(255) CHARACTER SET utf8 NOT NULL,
  `occOptions` varchar(255) CHARACTER SET utf8 NOT NULL,
  `maryOptions` varchar(255) CHARACTER SET utf8 NOT NULL,
  `nationOptions` varchar(255) CHARACTER SET utf8 NOT NULL,
  `height` varchar(255) CHARACTER SET utf8 NOT NULL,
  `weight` varchar(255) CHARACTER SET utf8 NOT NULL,
  `pressure` varchar(255) CHARACTER SET utf8 NOT NULL,
  `pulse` varchar(255) CHARACTER SET utf8 NOT NULL,
  `congenOptions` varchar(255) CHARACTER SET utf8 NOT NULL,
  `location` text CHARACTER SET utf8 NOT NULL,
  `period` text CHARACTER SET utf8 NOT NULL,
  `reason1` text CHARACTER SET utf8 NOT NULL,
  `reason2` text CHARACTER SET utf8 NOT NULL,
  `motiOptions` varchar(255) CHARACTER SET utf8 NOT NULL,
  `exer` text CHARACTER SET utf8 NOT NULL,
  `pulseAfter` varchar(255) CHARACTER SET utf8 NOT NULL,
  `week` varchar(255) CHARACTER SET utf8 NOT NULL,
  `intensityOptions` varchar(255) CHARACTER SET utf8 NOT NULL,
  `duration` varchar(255) CHARACTER SET utf8 NOT NULL,
  `agency_name1` varchar(255) CHARACTER SET utf8 NOT NULL,
  `agency_name2` varchar(255) CHARACTER SET utf8 NOT NULL,
  `community` varchar(255) CHARACTER SET utf8 NOT NULL,
  `loc_community` varchar(255) NOT NULL,
  `loc_agency` varchar(255) CHARACTER SET utf8 NOT NULL,
  `business` varchar(255) CHARACTER SET utf8 NOT NULL,
  `exper_sports` text CHARACTER SET utf8 NOT NULL,
  `res` text CHARACTER SET utf8 NOT NULL,
  `pub_res` text CHARACTER SET utf8 NOT NULL,
  `train_exper_exer` text CHARACTER SET utf8 NOT NULL,
  `train_exper` text CHARACTER SET utf8 NOT NULL,
  `vol_exper` varchar(255) CHARACTER SET utf8 NOT NULL,
  `org_heal` varchar(255) CHARACTER SET utf8 NOT NULL,
  `pro_org_exer` varchar(255) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `question` (`qid`, `username`, `name`, `surname`, `level`, `sex`, `province_id`, `amphure_id`, `age`, `eduOptions`, `occOptions`, `maryOptions`, `nationOptions`, `height`, `weight`, `pressure`, `pulse`, `congenOptions`, `location`, `period`, `reason1`, `reason2`, `motiOptions`, `exer`, `pulseAfter`, `week`, `intensityOptions`, `duration`, `agency_name1`, `agency_name2`, `community`, `loc_community`, `loc_agency`, `business`, `exper_sports`, `res`, `pub_res`, `train_exper_exer`, `train_exper`, `vol_exper`, `org_heal`, `pro_org_exer`, `activity`) VALUES
(83, '1', 'ณภัทร ', 'สุขใส', 'Interested-Individual', 'ชาย', 11, 136, '31', 'มัธยมศึกษาตอนต้น', 'รับราชการ/เจ้าหน้าที่ของรัฐ', 'โสด', 'ไทย', '173', '63', '120/60', '60', 'มี', 'บ้าน/บริเวณที่พักอาศัย', '14:00 - 15:00', 'กำลังเป็นที่นิยม/ตามกระแสนิยม', 'ไม่มีสถานที่', 'ทัศนคติในการออกกำลังกาย', 'รำมวยจีน', '60', '5', 'ระดับปานกลาง', '20', '---', '---', '---', '---', '---', '---', '---,---', '---,---', '---,---', '---,---', '---,---', '---', '---', '---', '---'),
(84, '2', 'กาญจนา', ' วิเชียรสุข', 'Trainers', 'หญิง', 57, 797, '38', 'ประถมศึกษา', 'รับราชการ/เจ้าหน้าที่ของรัฐ', 'โสด', 'ไทย', '50', '1', '123', '123', 'มี', 'บ้าน/บริเวณที่พักอาศัย', '00:00 - 01:00', 'ต้องการให้ร่างกายแข็งแรง', 'ป่วย', 'ทัศนคติในการออกกำลังกาย', 'เดิน', '60', '1', 'ระดับปานกลาง', '10', 'a1', 'a1', '---', '---', 'a1', '---', 'x2,x3,x1', '---,---', '---,---', 'x5,x4', 'x7,x6', '---', '---', '---', '---'),
(85, '3', 'พรชัย', 'มีสุข', 'Sport-professionals', 'ชาย', 55, 771, '24', 'ประถมศึกษา', 'รับราชการ/เจ้าหน้าที่ของรัฐ', 'โสด', 'ไทย', '50', '1', '123', '123', 'ไม่มี', 'ที่ทำงาน', '04:00 - 05:00', 'ทำกิจกรรมร่วมกับเพื่อน/เพื่อนชวน,ต้องการรูปร่างที่ดี/หุ่นดี', 'ไม่มีความรู้,น่าเบื่อหน่าย', 'ทัศนคติในการออกกำลังกาย', 'กระโดยเชือก,ฟุตบอล', '60', '6', 'ระดับหนัก', '60', 'a', 'a', '---', '---', 'a', '---', '  k1', 'k2', 'k3', 'k4', 'k5', '---', '---', '---', '---'),
(86, '4', 'สุริยา', 'ปราโมทย์', 'Volunteer', 'ชาย', 52, 739, '33', 'ไม่เคยเรียน', 'รับราชการ/เจ้าหน้าที่ของรัฐ', 'โสด', 'ไทย', '173', '1', '123', '123', 'มี', 'บ้าน/บริเวณที่พักอาศัย,ที่ทำงาน,โรงเรียน/สถานศึกษา,พื้นที่ทำการเกษตร เช่น สวน ไร่ นา เป็นต้น,สนามกีฬาประจำตำบล/อำเภอ/จังหวัด,ฟิตเนสหรือยิม,สวนสาธารณะ,ถนน/ทางสาธารณะ/ซอย', '00:00 - 01:00,01:00 - 02:00,02:00 - 03:00,03:00 - 04:00,04:00 - 05:00,06:00 - 07:00,11:00 - 12:00,12:00 - 13:00,14:00 - 15:00,16:00 - 17:00,17:00 - 18:00,20:00 - 21:00,21:00 - 22:00,22:00 - 23:00,23:00 - 24:00', 'ต้องการให้ร่างกายแข็งแรง,เป็นงานต้องทำ/เป็นอาชีพ,รักษา/บรรเทาอาการเจ็บป่วย,ใช้เวลาว่างให้เป็นประโยชน์,ต้องการรูปร่างที่ดี/หุ่นดี,คลายเครียด/พักผ่อน,ชอบออกกำลังกาย, ', 'ไม่ชอบการออกกำลังกาย,ไม่มีความรู้,ไม่มีสถานที่,ขาดแรงจูงใจ,สถานการณ์โรคอุบัติใหม่/สถานการณ์วิกฤต, ', 'ความรู้ในการออกกำลังกาย', 'เดิน,โยคะ', '', '1', 'ระดับปานกลาง', '1', '---', '---', '---', '---', '---', '---', '---,---', '---,---', '---,---', '---,---', '---,---', 'มี', '---', '---', '---'),
(87, '5', 'ภัทรวิชญ์', 'สุขสมบูรณ์', 'Personnel/Support-Staff', 'ชาย', 1, 1, '34', 'ไม่เคยเรียน', 'รับราชการ/เจ้าหน้าที่ของรัฐ', 'โสด', 'ไทย', '50', '1', '123', '123', 'มี', 'บ้าน/บริเวณที่พักอาศัย', '11:00 - 12:00', 'ใช้เวลาว่างให้เป็นประโยชน์', 'ไม่มีความรู้', 'สนามกีฬาหรือสถานที่มีความสวยงามมีมาตรฐาน', 'โยคะ,ฟุตซอล', '123', '100', 'ระดับปานกลาง', '100', 'a', 'a', '', '---', 'a', '123', '---,---', '---,---', '---,---', '---,---', '---,---', '---', 'มี', '1', '1'),
(89, '6', 'วิไล', 'พูลสวัสดิ์', 'Suppliers/Partners', '---', 0, 0, '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '---', '--', '---', '---', '---', '---', '---', '---', '---', '1', '1', '---', '---', '1', '1', '---,---', '---,---', '---,---', '---,---', '---,---', '---', '1', '1', '1');

-- --------------------------------------------------------

--
-- Table structure for table `work_login`
--

CREATE TABLE `work_login` (
  `ID` int(11) NOT NULL,
...
--
-- Dumping data for table `work_login`
--

INSERT INTO `work_login` (`ID`, `username`, `password`, `name`, `surname`, `bday`, `level`, `status`) VALUES
(1, '111', '698d51a19d8a121ce581499d7b701668', 'ADMIN', '', '2023-08-02', 'ADMIN', 1),
(2, '1', 'c4ca4238a0b923820dcc509a6f75849b', 'ณภัทร ', 'สุขใส', '1992-03-15', 'Interested-Individual', 1),
(3, '2', 'c81e728d9d4c2f636f067f89cc14862c', 'กาญจนา', ' วิเชียรสุข', '1985-05-07', 'Trainers', 1),
(4, '3', 'eccbc87e4b5ce2fe28308fd9f2a7baf3', 'พรชัย', 'มีสุข', '1998-10-12', 'Sport-professionals', 1),
(5, '4', 'a87ff679a2f3e71d9181a67b7542122c', 'สุริยา', 'ปราโมทย์', '1990-08-28', 'Volunteer', 1),
(6, '5', 'e4da3b7fbbce2345d7772b0674a318d5', 'ภัทรวิชญ์', 'สุขสมบูรณ์', '1987-12-03', 'Personnel/Support-Staff', 1),
(7, '6', '1679091c5a880faf6fb5e6087eb1b2dc', 'วิไล', 'พูลสวัสดิ์', '1994-06-20', 'Suppliers/Partners', 1),
(8, '7', '8f14e45fceea167a5a36dedd4bea2543', 'สิริภัทร', 'อินทรวิจิตร', '1989-04-09', 'Community', 1),
(9, '11', '6512bd43d9caa6e02c990b0a82652dca', 'กฤษณะ', 'สุวรรณโสภา', '1980-03-15', 'Interested-Individual', 1),
(10, '22', 'b6d767d2f8ed5d21a44b0e5886680cb9', 'ณัฐกานต์', 'จันทร์เพ็ญ', '1985-05-07', 'Trainers', 1),
(11, '33', '182be0c5cdcd5072bb1864cdee4d3d6e', 'ศุภวิชญ์', 'พงศ์วิศาล', '1998-10-12', 'Sport-professionals', 1),
(12, '44', 'f7177163c833dff4b38fc8d2872f1ec6', 'อรรถวุฒิ', 'รักษ์สมบัติ', '1990-08-28', 'Volunteer', 1),
(13, '55', 'b53b3a3d6ab90ce0268229151c9bde11', 'วรัญชน์', 'พุ่มพวง', '1987-12-03', 'Personnel/Support-Staff', 1),
(14, '66', '3295c76acbf4caaed33c36b1b5fc2cb1', 'จริงเจริญ', 'สุขสมบูรณ์', '1994-06-20', 'Suppliers/Partners', 1),
(15, '77', '28dd2c7955ce926456240b2ff0100bde', 'สุวิชญา', 'รักษาพงษ์', '1989-04-09', 'Community', 1);
...
--
-- Indexes for table `work_login`
--
ALTER TABLE `work_login`
  ADD PRIMARY KEY (`ID`);
...
--
ALTER TABLE `question`
  MODIFY `qid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT for table `work_login`
--
ALTER TABLE `work_login`
